...
import com.example.skillsphere.exception.ModuleNotFoundException;
...
public class VideoService {
    ...
    private final String uploadDir = "C:\\A Java SkillSphere\\skillsphere\\src\\main\\resources\\static\\videos\\";
    ...
    public List<Video> findAllVideosByModuleId(Long moduleId) {
        Modules module = modulesRepository.findById(moduleId)
            .orElseThrow(() -> new ModuleNotFoundException("Module with moduleId: " + moduleId + " does not exist"));
    ...
    public Video findVideoByIdForModule(Long moduleId, Long videoId) {
        return videoRepository.findById(videoId)
            ...
            .orElseThrow(() -> new VideoNotFoundException("Video with videoId: " + videoId + " does not exist or does not belong to the specified module"));
    }
