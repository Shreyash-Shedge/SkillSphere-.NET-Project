...
public class ModuleController {
	...
	public ResponseEntity<Modules> createModulesForCourse(@PathVariable Long courseId, @Valid @RequestBody Modules module) {
	...
	public Modules updateModuleForCourse(@PathVariable Long courseId, @PathVariable Long moduleId, @Valid @RequestBody Modules module) {
