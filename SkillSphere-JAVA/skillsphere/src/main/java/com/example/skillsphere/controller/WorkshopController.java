...
import com.example.skillsphere.service.WorkshopService;
...
public class WorkshopController {
    ...
    public ResponseEntity<Workshop> createWorkshopForCreator(@PathVariable Long creatorId, @Valid @RequestBody Workshop workshop) {
    ...
    public ResponseEntity<Workshop> deleteWorkshopForCreator(@PathVariable Long creatorId, @PathVariable Long workshopId) {
        return workshopService.deleteWorkshopForCreator(creatorId, workshopId);
    }

    @PutMapping("/{creatorId}/workshops/{workshopId}")
    public Workshop updateWorkshopForCreator(@PathVariable Long creatorId, @PathVariable Long workshopId, @Valid @RequestBody Workshop workshop) {
